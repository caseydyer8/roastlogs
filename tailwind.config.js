  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'phase-dry': 'rgb(var(--phase-dry) / <alpha-value>)',
        'phase-mai': 'rgb(var(--phase-mai) / <alpha-value>)',
        'phase-car': 'rgb(var(--phase-car) / <alpha-value>)',
        'phase-dev': 'rgb(var(--phase-dev) / <alpha-value>)',
        'phase-cool': 'rgb(var(--phase-cool) / <alpha-value>)',
      },
    },
  },
  plugins: [],
