...
function FlavorGlyph({ id, className = "h-6 w-6" }) {
  const glyphs = {
    ...
    sweet: <path d="M12.82 9.14L11.18 12L7.88 12L6.23 9.14L7.88 6.28L11.18 6.28ZM12.82 14.86L11.18 17.72L7.88 17.72L6.23 14.86L7.88 12L11.18 12ZM17.77 12L16.13 14.86L12.82 14.86L11.18 12L12.82 9.14L16.13 9.14Z" />,
    nutty: <><path d="M7 10.5c0-3.1 2.2-5.2 5-5.2s5 2.1 5 5.2" /><path d="M7 10.5h10c0 4-2.2 8-5 8s-5-4-5-8Z" /></>,
    spicy: <><path d="M15.5 7.5C17 9 17 11.5 15.5 14 13.5 17.3 9.5 19.8 7 19 5.9 18.6 5.9 17.2 7 16.8 10.5 15.6 12.8 12.8 13 9.8 13.1 8.4 13.6 7.6 14.4 7.2 14.8 7 15.2 7.1 15.5 7.5Z" /><path d="M14.6 7.2C14.4 5.4 15.4 4.3 17.2 4.6" /></>,
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-primary/80 p-4 backdrop-blur-sm" onClick={() => setShowAboutModal(false)}>
          <div className="relative w-full max-w-sm animate-in zoom-in-95 duration-200 rounded-3xl border border-border/60 bg-surface p-6 shadow-2xl max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-center">
              ...
              <div className="mt-1 text-sm font-mono text-ink-muted">v3.3.0</div>
